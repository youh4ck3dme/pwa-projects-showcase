    ...
    <div className="min-h-screen bg-bone pt-32 pb-24">
      <div className="container-tight">
        ...
        <motion.div 
          ...
          className="mb-20 border-b-4 border-black pb-16"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
             <div className="p-6 bg-white border-2 border-black flex items-center gap-4">
             ...
             <div className="p-6 bg-black text-white flex items-center gap-4 border-2 border-black">
