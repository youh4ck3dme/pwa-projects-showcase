...
export default function ProjectsPage() {
  ...
  return (
    <div className="container-full">
      <div className="border-b border-black px-8 lg:px-10 py-24 bg-white">
        <motion.div 
        ...
        <motion.h1 
          ...
          className="text-8xl font-black tracking-tighter max-w-5xl leading-[0.8] uppercase"
        ...
        <motion.p 
          ...
          className="mt-12 text-xl font-medium text-charcoal max-w-xl leading-snug uppercase tracking-tighter opacity-70"
        >
          {t('description', 'home')}
        </motion.p>
      </div>
